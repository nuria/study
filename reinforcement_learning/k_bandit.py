...
class Bandit:
    ...
    def __init__(self, k, seed=None, exploration_rate=.3, learning_rate= 0.1):
        ...
        # this array keeps teh estimates for values that are updated after each action taken
        ...
        # the exploration_rate is teh epsilon in the e-greedy methods
...
if __name__=="__main__":
    ...
    print("playing 10 bandits, 1000 times seed 678")
    play(1000, 10, 678)

    print("playing 10 bandits, 2000 times seed 4567")
    play(2000, 10, 4567)
